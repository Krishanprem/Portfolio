        ...
        <footer className="relative overflow-hidden pt-8 pb-4">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col items-center">
                ...
                <div className="flex justify-center gap-5 mb-4">
                    {[
                        { icon: <Github size={22} />, href: 'https://github.com/Krishanprem', color: '#a855f7' },
                        { icon: <Linkedin size={22} />, href: 'https://www.linkedin.com/in/krishan-prem', color: '#6366f1' },
                        { icon: <Mail size={22} />, href: 'mailto:Mrkrishanprem@gmail.com', color: '#14b8a6' },
                    ].map((item, i) => (
                        <a
                ...
                <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-2xl gap-4 text-sm text-slate-500 font-medium">
                    <p className="flex items-center gap-1.5 transition-colors hover:text-slate-300">
                        Designed & Built by Krishan Kumar Das
                    </p>
