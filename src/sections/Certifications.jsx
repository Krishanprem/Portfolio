...
import cert1 from '../assets/certs/Cipher_School.jpg';
import cert2 from '../assets/certs/53 tpl certi.pdf';
import cert3 from '../assets/certs/Build Generative AI Apps and Solutions with No-Code Tools.pdf';
import cert4 from '../assets/certs/ChatGPT-4 Prompt Engineering ChatGPT, Generative AI & LLM.pdf';
import cert5 from '../assets/certs/Computational Theory Language Principle & Finite Automata Theory.pdf';
import cert6 from '../assets/certs/Master Generative AI & Generative AI tools (ChatGPT & more).pdf';
import cert7 from '../assets/certs/The Bits and Bytes of Computer Networking.pdf';

const certifications = [
    {
        title: 'Cipher School Training',
    ...
    {
        title: 'Build Generative AI Apps via No-Code',
        issuer: 'Infosys',
        icon: '⚙️',
        color: '#14b8a6',
        accent: '#0d9488',
...
const CertCard = ({ cert, index }) => {
    ...
    const isPdf = typeof cert.image === 'string' && cert.image.toLowerCase().endsWith('.pdf');
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    {/* Certificate image */}
                    <div className="relative w-full h-52 overflow-hidden bg-slate-900 flex items-center justify-center">
                        {isPdf ? (
                            <iframe
                                src={`${cert.image}#toolbar=0&navpanes=0&scrollbar=0`}
                                title={cert.title}
                                className="w-[110%] h-[110%] object-cover pointer-events-none opacity-75"
                    ...
                    {showPreview && (
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="md:flex-[3] relative flex items-center justify-center p-4 md:p-6 h-[40vh] md:h-auto overflow-hidden bg-slate-900/50"
...
const Certifications = () => (
    <section id="certifications" className="py-28 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
                {[
                    { label: 'Certifications', value: '7', color: '#c084fc' },
                    { label: 'Platforms', value: '4+', color: '#14b8a6' },
