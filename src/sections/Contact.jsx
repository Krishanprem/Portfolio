                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-3">
                            {[
                                { icon: <Mail size={18} />, label: 'Mrkrishanprem@gmail.com', href: 'mailto:Mrkrishanprem@gmail.com', color: '#14b8a6' },
                                { icon: <Linkedin size={18} />, label: 'LinkedIn Profile', href: 'https://www.linkedin.com/in/krishan-prem', color: '#6366f1' },
                                { icon: <Github size={18} />, label: 'GitHub Projects', href: 'https://github.com/Krishanprem', color: '#a855f7' },
