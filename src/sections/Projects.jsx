...
const projects = [
    {
        num: '01',
        title: 'AI Travel',
        category: 'AI Language Translator',
        description: 'Engineered an AI-driven multilingual translator with real-time text translation, conversation mode, and pronunciation guides tailored for travelers. Integrated offline-friendly speech output using pyttsx3. Designed a clean, mobile-responsive UI in Streamlit.',
        tags: [
        ...
        metrics: [
            { icon: <TrendingUp size={13} />, label: 'Real-time' },
            { icon: <Star size={13} />, label: 'Offline Speech' },
            { icon: <Zap size={13} />, label: 'Streamlit UI' },
        ],
        github: 'https://github.com/Krishanprem/AI-Language-Translator-for-Travelers',
        accent: '#6366f1',
        ...
        mockupBadges: ['AI', 'Travel', 'Offline'],
    },
    {
        num: '02',
        title: 'E-Roadways',
        category: 'Online Bus Booking',
        description: 'Developed a full-stack web application for online bus ticket booking, schedule management, and user account handling. Implemented secure user authentication, seat selection, and built admin features including bus management, route creation, and booking oversight.',
        tags: [
        ...
        metrics: [
            { icon: <TrendingUp size={13} />, label: 'Secure Auth' },
            { icon: <Shield size={13} />, label: 'Admin Panel' },
            { icon: <Zap size={13} />, label: 'Seat Selection' },
        ],
        // Linking to main profile as fallback, since the exact repo name wasn't found in top 6, but could also be generic name
        github: 'https://github.com/Krishanprem/E-Roadways',
        accent: '#10b981',
        ...
        mockupBadges: ['Booking', 'Admin', 'Tickets'],
    },
];
